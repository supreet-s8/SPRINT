...
echo " "
sh /data/GDS/MonitoringScript/helperScript/collectorLag.sh
...
echo "#############################################"
sh /data/GDS/MonitoringScript/helperScript/getJobsStatus.sh

echo "#############################################"
echo "RUNNING WORKFLOW JOBS"
echo "#############################################"
sleep 5
/opt/tms/bin/pmx subshell oozie show workflow RUNNING jobs | awk '{print $1,$2}'

echo "#############################################"
echo "Checking Disk Usage"
echo "#############################################"
sh /data/GDS/MonitoringScript/helperScript/diskSpace.sh

echo "#############################################"
echo "Checking Hadoop Health"
echo "#############################################"
sh /data/GDS/MonitoringScript/helperScript/hadoopHealth.sh
...
echo "############################################"
sh /data/GDS/MonitoringScript/helperScript/mountPoint.sh


#echo "############################################"
#echo "Checking SAS_Box Health"
#echo "############################################"
#python /data/GDS/MonitoringScript/helperScript/SAShealth.py >/data/GDS/MonitoringScript/Monitoring_Output/SAS.txt
#echo "############################################"
